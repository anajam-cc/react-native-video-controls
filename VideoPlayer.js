...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    renderBottomControls() {
        ...
        const timerControlRegisterVideo = this.props.disableTimer ? this.renderNullControl() : this.renderTimerRegisterVideo();
        ...
        return (
            <Animated.View style={[
                ...
                <ImageBackground
                    ...
                    imageStyle={[styles.controls.vignette]}>
                    {seekbarControl}
                    {this.state.registerVideo ? (
                        <View style={[
                            styles.controls.row,
                            styles.controls.bottomControlGroupRegisterVideo
                        ]}>
                            {playPauseControl}
                            {this.renderTitle()}
                            {timerControlRegisterVideo}
    ...
    renderTimerRegisterVideo() {
        return this.renderControl(
            <Text style={styles.controls.timerTextRegisterVideo}>
                {this.calculateTime()}
            </Text>,
            this.methods.toggleTimer,
            styles.controls.timerRegisterVideo
        );
    }
...
const styles = {
    ...
    controls: StyleSheet.create({
        ...
        bottomControlGroupRegisterVideo: {
            alignSelf: 'stretch',
            alignItems: 'stretch',
            justifyContent: 'space-between',
            marginBottom: 0,
